...
from keras.layers import Dense, LSTM, Activation, Dropout, Embedding, Conv1D, MaxPooling1D, SimpleRNN
...
def build_LSTM_model(trainData, trainBatches, testData, testBatches, windowSize, class_count, numCalls, batch_size):
    ...
    model.add(SimpleRNN(num_units,input_shape=(windowSize, api_count),return_sequences=False))
